...
public final class PrismaticJointDef
    ...
    public static final VarHandle TARGET_TRANSLATION;
    ...
    public static final long TARGET_TRANSLATION_OFFSET;
    ...
    static {
        ...
        TARGET_TRANSLATION = LAYOUT.varHandle(PathElement.groupElement("targetTranslation"));
        ...
        TARGET_TRANSLATION_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("targetTranslation"));
    ...
    public PrismaticJointDef targetTranslation(float targetTranslation) {
        TARGET_TRANSLATION.set(segment, 0L, targetTranslation);
        return this;
    }
    
    public float targetTranslation() {
        return (float) TARGET_TRANSLATION.get(segment, 0L);
    }
