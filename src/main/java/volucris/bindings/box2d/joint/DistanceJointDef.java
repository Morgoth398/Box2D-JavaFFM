...
public final class DistanceJointDef
    ...
    public static final VarHandle LENGTH;
    ...
    public static final VarHandle MIN_LENGTH;
    public static final VarHandle MAX_LENGTH;
    public static final VarHandle ENABLE_MOTOR;
    public static final VarHandle MAX_MOTOR_FORCE;
    ...
    public static final long MIN_LENGTH_OFFSET;
    public static final long MAX_LENGTH_OFFSET;
    public static final long ENABLE_MOTOR_OFFSET;
    public static final long MAX_MOTOR_FORCE_OFFSET;
    ...
    static {
        ...
        LENGTH = LAYOUT.varHandle(PathElement.groupElement("length"));
        ...
        MIN_LENGTH = LAYOUT.varHandle(PathElement.groupElement("minLength"));
        MAX_LENGTH = LAYOUT.varHandle(PathElement.groupElement("maxLength"));
        ENABLE_MOTOR = LAYOUT.varHandle(PathElement.groupElement("enableMotor"));
        MAX_MOTOR_FORCE = LAYOUT.varHandle(PathElement.groupElement("maxMotorForce"));
        ...
        LENGTH_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("length"));
        ...
        MIN_LENGTH_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("minLength"));
        MAX_LENGTH_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("maxLength"));
        ENABLE_MOTOR_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("enableMotor"));
        MAX_MOTOR_FORCE_OFFSET = LAYOUT.byteOffset(PathElement.groupElement("maxMotorForce"));
    ...
    public DistanceJointDef length(float length) {
        LENGTH.set(segment, 0L, length);
        return this;
    }
    
    public float length() {
        return (float) LENGTH.get(segment, 0L);
    }
    ...
    public DistanceJointDef minLength(float minLength) {
        MIN_LENGTH.set(segment, 0L, minLength);
        return this;
    }
    
    public float minLength() {
        return (float) MIN_LENGTH.get(segment, 0L);
    }
    
    public DistanceJointDef maxLength(float maxLength) {
        MAX_LENGTH.set(segment, 0L, maxLength);
        return this;
    }
    
    public float maxLength() {
        return (float) MAX_LENGTH.get(segment, 0L);
    }
    ...
    public DistanceJointDef maxMotorForce(float maxMotorForce) {
        MAX_MOTOR_FORCE.set(segment, 0L, maxMotorForce);
        return this;
    }
    
    public float maxMotorForce() {
        return (float) MAX_MOTOR_FORCE.get(segment, 0L);
    }
